...
// OVERLAY of immutable-collections LambdaReflection (from ../immutable-collections, API-compatible with 6.0.2)
// for the TeaVM (browser) build - deltas: serialized() returns null, LambdaImpl equals/hashCode/name
// fall back to the lambda class when serialized is null.
...
public interface LambdaReflection extends Serializable {
    ...
    default SerializedLambda serialized() {
        // no SerializedLambda/writeReplace under TeaVM; LambdaImpl falls back to the lambda class
        return null;
    }
    ...
    abstract class LambdaImpl<F extends LambdaReflection> implements LambdaReflection {
        ...
        public LambdaImpl(F f) {
            ...
            this.hashCode = serialized != null ? LambdaReflection.hash(serialized) : f.getClass().hashCode();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (hashCode != other.hashCode) {
                return false;
            } else if (serialized != null && other.serialized != null) {
                return LambdaReflection.equal(serialized, other.serialized);
            } else {
                return f.getClass() == other.f.getClass();
            }
        }

        @Override
        public String getImplMethodName() {
            return serialized != null ? serialized.getImplMethodName() : f.getClass().getName();
        }

        @Override
        public String toString() {
            // return LambdaReflection.string(serialized);
            return (serialized != null ? serialized.getImplMethodName() : f.getClass().getName()) + StringUtil.toString(capturedArgs());
        }
        ...
        public Object[] capturedArgs() {
            return serialized != null ? LambdaReflection.capturedArgs(serialized) : new Object[0];
        }
