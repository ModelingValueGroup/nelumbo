...
// OVERLAY of the core KnowledgeBase for the TeaVM (browser) build - deltas: no ForkJoin POOL/LogicTask,
// run(Runnable) executes synchronously on the calling thread, cleanup() runs inline.
