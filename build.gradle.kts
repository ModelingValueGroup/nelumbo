...
// shown as the pom description on maven central (mvgplugin falls back to "<artifact> by <group>")
description = "Declarative logic meta-language: define the syntax and semantics of your own language in a .nl file, then run and test it from that same file."
