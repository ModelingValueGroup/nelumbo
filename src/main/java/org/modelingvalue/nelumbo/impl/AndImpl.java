...
public final class AndImpl extends BinaryPredicateImpl {
    private static final long                                          serialVersionUID = -7248491569810098948L;

    private static final FunctorImpl2<Predicate, Predicate, Predicate> AND_FUNCTOR      = FunctorImpl.of2(AndImpl::and);
    ...
    protected AndImpl struct(Object[] array, PredicateImpl declaration) {
        return new AndImpl(array, (AndImpl) declaration);
    }
