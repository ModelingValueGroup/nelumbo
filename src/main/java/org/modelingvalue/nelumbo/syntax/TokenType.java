...
public enum TokenType {
    ...
    STRING("\"([^\"\\\\\\v]|\\\\[^\\v])*\"", VARIABLE_CONTENT), // single line: an unclosed quote must not swallow the rest of the file
    ...
    OPERATOR("(?:(?!//|/\\*)[~!@#$%^&*=+|:<>.?/-])+", CONTINUES_ON_NEXT_LINE, VARIABLE_CONTENT), // stops before a comment start
