...
public class NelumboEditor {
    ...
    // LabelView that guards against stale zero-length elements (JDK bug in GlyphView.getText).
    // Overrides getText() — the single source of all StateInvariantError throws — so all
