 ...
 * and viewer dialogs.
 */
public class EditorWindow extends WindowAdapter implements WindowListener, Runnable, DocumentListener {
    ...
    private int                   windowNumber = -1;  // Window number for regular windows
    ...
    private void initWindow() {
        ...
        if (isExample && exampleDisplayName != null) {
            ...
            // Regular windows use "Nelumbo <n>" format (number already assigned)
            title = "Nelumbo " + windowNumber;
        }
    ...
    private void updateWindowsMenu() {
        ...
        javax.swing.SwingUtilities.invokeLater(() -> {
            ...
            for (EditorWindow window : windows) {
                ...
                EditorWindow targetWindow = window;
                item.addActionListener(e -> bringWindowToFront(targetWindow));
    ...
    private void convertToEditableWindow() {
        ...
        // Update the title
        String newTitle = "Nelumbo " + windowNumber;
