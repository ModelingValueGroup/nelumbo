...
public class TokenTypePattern extends Pattern {
    ...
    @NelumboConstructor
    public TokenTypePattern(NodeInfo nodeInfo, Object... args) {
        super(nodeInfo, args);
    }

    @Override
    protected TokenTypePattern set(NodeInfo nodeInfo, Object[] args) {
        return new TokenTypePattern(nodeInfo, args);
    }
