...
const tokenTypeDefs: TokenTypeDef[] = [
  ...
  { name: 'LEFT', pattern: /^[(\[{]/, flags: TokenTypeFlag.CONTINUES_ON_NEXT_LINE },
  { name: 'RIGHT', pattern: /^[)\]}]/, flags: 0 },
  ...
  { name: 'NEWLINE', pattern: /^(\r\n|\r|\n)/, flags: TokenTypeFlag.LAYOUT },
  { name: 'HSPACE', pattern: /^[ \t]+/, flags: TokenTypeFlag.SKIP },
  { name: 'END_LINE_COMMENT', pattern: /^\/\/[^\r\n]*/, flags: TokenTypeFlag.SKIP },
  { name: 'IN_LINE_COMMENT', pattern: /^\/\*[\s\S]*?(\*\/|$)/, flags: TokenTypeFlag.SKIP },
  { name: 'OPERATOR', pattern: /^(?!\/\/|\/\*)[~!@#$%^&*=+|:<>.?/-]+/, flags: 0 },
